...
- **Shares** are recorded under `pos * 8 + seat`; readers take them from the ledger, so a card is readable to whoever the protocol says as soon as the last share lands. A player's own hole positions and positions never dealt are refused.
